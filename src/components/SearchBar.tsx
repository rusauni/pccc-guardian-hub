    ...
    <div className="w-full border-b bg-muted/40">
      <div className="container py-4">
        <button
          ...
          className="flex w-full max-w-sm items-center gap-2 rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm mx-auto h-9"
        >
          <Search className="h-4 w-4 opacity-50" />
          <span className="text-muted-foreground">Tra cứu văn bản pháp luật...</span>
